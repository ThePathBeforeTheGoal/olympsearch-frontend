              ...
              {finalCategories
                ...
                .map((cat) => (
                  ...
                  >
                    ...
                    <div className="group cursor-pointer bg-white/10 backdrop-blur-xl rounded-3xl border border-white/20 hover:border-purple-300/50 hover:bg-white/15 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 h-full min-h-[250px] flex flex-col">
                      <div className="p-4 sm:p-6 lg:p-8 text-center flex flex-col items-center justify-between h-full flex-grow">
                        {/* Иконка категории */}
                        <div className="flex-shrink-0 mb-3 sm:mb-4">
                          <div className="relative w-16 h-16 sm:w-20 lg:w-24 sm:h-20 lg:h-24 group-hover:scale-110 transition-transform duration-500">
